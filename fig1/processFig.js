...
function createFig1(response) {
  ...
  var layout = {
    ...
    title: 'Range glucose: GB:5-6 G120:7-8',
...
function createFig1B(response) {
  ...
  var layout = {
    ...
    title: 'Range Insuline: IB:10-60 I120:200-300',
...
function createFig2B(response){
  ...
  var layout = {
    ...
    title: 'Insuline profiles in Glucose group 1',
...
function createFig3B(response){
  ...
  var layout = {
    ...
    title: 'Glucose profiles in Insuline group 1',
